...
2. [Git(Hub) + RStudio](#rstudio)

3. [Git from the shell](#shell)
...
- I use it for research, classes, and host and maintain my website using [GitHub Pages](https://pages.github.com/) (more on this later)
...
I also want to restate a general point that we'll revisit many times during this course: 
...
.footnote[<sup>1</sup> It's easier to start with HTTPS, but <a href="http://happygitwithr.com/ssh-keys.html#ssh-keys" target="_blank">SSH</a> is advised for more advanced users.]
...
<div align="center">
<img src="02-git-files/figures/git-local-change.gif" height=500>
</div>
...
<div align="center">
<img src="02-git-files/figures/git-stage-commit.gif" height=500>
</div>
...
<div align="center">
<img src="02-git-files/figures/git-push-pull.gif" height=400>
</div>
...
<!-- PS — You were likely challenged for your GitHub credentials at some point. Learn how to cache these and how to use a personal access token (we discussed this in the [previous lecture](https://raw.githack.com/dadepro/mkt-615/main/lectures/01-intro/01-intro.html#20)) [here](https://happygitwithr.com/credential-caching.html) -->
...
However, I want to go over Git <a href="http://happygitwithr.com/ssh-keys.html#shell" target="_blank">shell</a> commands so that you can internalize the basics
- The shell is more powerful and flexible and does some things that the RStudio Git GUI can't
...
Recall that I told you that recently GitHub updated its security requirements and now uses 2FA. This means that to access Git via Shell you need a token.

Two steps:
  1. Create a [GitHub access token](https://docs.github.com/en/github/authenticating-to-github/keeping-your-account-and-data-secure/creating-a-personal-access-token)
  2.  **Save it somewhere** and use it to authenticate (instead of the password) in the shell

P.S: Note that the git password is probably saved so you need to tell git to ask for the password again. Some help can be found [here](https://stackoverflow.com/questions/68775869/support-for-password-authentication-was-removed-please-use-a-personal-access-to)
...
PS: There are many more commands that we won't have time to cover. For example, reverting to a previous commit can be useful in certain cases (e.g., your code don't compile anymore and you don't have any idea why ;)), some more info about this is [here](https://stackoverflow.com/questions/4114095/how-do-i-revert-a-git-repository-to-a-previous-commit)
...
.footnote[<sup>1</sup> Other good choices are <a href="https://code.visualstudio.com/" target="_blank">Visual Studio Code</a>, [Sublime](https://www.sublimetext.com/),  or <a href="https://atom.io/" target="_blank">Atom</a>, which support GitHub integration. You can set your preferred default editor with `$ git config --global core.editor "PREFERRED_EDITOR"`.]
...
The problem is that Git evaluates an invisible character at the end of every line. This is how Git tracks changes. (More info [here](https://help.github.com/articles/dealing-with-line-endings/) and [here](https://en.wikipedia.org/wiki/Newline).)
...
Branches are one of Git's most interesting features
...
<div align="center">
<img src="02-git-files/figures/git-new-branch.gif" height=500>
</div>
...
<div align="center">
<img src="02-git-files/figures/git-pr.gif" height=500>
</div>
...
A .gitignore file tells Git what to ignore (i.e., not keep track of it)
...
If you haven't done so already, now is a good time to clone the course materials to your local computer.
