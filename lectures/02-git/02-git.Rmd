...
<div align="center">
<img src="02-git-files/figures/git-push-pull.gif" height=500>
</div>
...
Recall that I tolde you that recently GitHub updated its security requirements and now uses 2FA. This means that to access Git via Shell you need a token.
...
- Allow you to take a snapshot of your existing repo and try out a whole new idea *without affecting* your main (i.e., "master" or "main") branch
