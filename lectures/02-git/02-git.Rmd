...
Two steps:
  ...
  2.  **Save it somewhere** and use it to authtenticate (isntead of the password) in the shell
  3. Note that the git password is probably saved so you need to tell git to ask for the password again. Some help can be found [here](https://stackoverflow.com/questions/68775869/support-for-password-authentication-was-removed-please-use-a-personal-access-to))
